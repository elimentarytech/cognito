...
/**
 * Debug build script for Cognito AI Extension
 * No obfuscation for easy debugging
 */
...
console.log('🔨 Building Cognito AI Extension for Debug...');
...
execSync(`cd "${buildDir}" && zip -r "../dist/cognito-ai-extension-debug.zip" . -x "*.DS_Store"`);

console.log('✅ Debug build complete!');
console.log('📦 Distribution package: dist/cognito-ai-extension-debug.zip');
console.log('🔍 No obfuscation - perfect for debugging');
console.log('');
